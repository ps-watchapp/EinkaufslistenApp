...
import md2.einkaufszettel.md2.controller.action.SpaeterEinkaufen_SpaeterEinkaufen_StarteArtikelAnsehen_Action;
import md2.einkaufszettel.md2.controller.action.SpaeterEinkaufen_SpaeterEinkaufen_BewegeArtikelEinkaufszettel_Action;

public class SpaeterEinkaufenViewListAdapter extends RecyclerView.Adapter{
	...
	public SpaeterEinkaufenViewListAdapter(){
		content = Md2ContentProviderRegistry.getInstance().getContentMultiProvider("SpaeterEinkaufenProvider");
		swipeHandler = new Md2ButtonOnSwipeHandler();
		clickHandler = new Md2OnClickHandler();
		Md2Action ca = new SpaeterEinkaufen_SpaeterEinkaufen_StarteArtikelAnsehen_Action();
		clickHandler.registerAction(ca);
		Md2Action rsa = new SpaeterEinkaufen_SpaeterEinkaufen_BewegeArtikelEinkaufszettel_Action();
	...
	public void onBindViewHolder(RecyclerView.ViewHolder vh, int i){
		...
		//Listener hinzufügen
		Md2UpdateListIndexAction indexAction = new Md2UpdateListIndexAction("SpaeterEinkaufenView", i, content);
