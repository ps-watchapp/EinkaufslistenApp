...
public class EinkaufszettelViewActivity extends WearableActivity implements WearableActionDrawer.OnMenuItemClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_einkaufszettelview);

        clickHandler = new Md2OnClickHandler();


	     		drawerLayout = (WearableDrawerLayout) findViewById(R.id.drawer_layout_EinkaufszettelView);
	        	drawerLayout.setDrawerStateCallback(new WearableDrawerLayout.DrawerStateCallback() {
	            	...
	            	public void onDrawerClosed(View view) {
	                	if(adapter.close()){
	                		EinkaufszettelViewActivity.this.finish();
	                	}
	            	}
	            	@Override
        ...
        navigationDrawer = (WearableNavigationDrawer) findViewById(R.id.navigation_drawer_EinkaufszettelView);
		...
		WearableRecyclerView wrv = (WearableRecyclerView) findViewById(R.id.wearable_recycler_view_EinkaufszettelView);
							    	EinkaufszettelViewListAdapter listAdapter = new EinkaufszettelViewListAdapter();
