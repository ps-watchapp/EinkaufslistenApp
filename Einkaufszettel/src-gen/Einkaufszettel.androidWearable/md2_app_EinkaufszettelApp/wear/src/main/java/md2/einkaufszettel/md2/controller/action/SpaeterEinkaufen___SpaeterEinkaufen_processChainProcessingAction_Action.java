...
public class SpaeterEinkaufen___SpaeterEinkaufen_processChainProcessingAction_Action extends AbstractMd2Action {

    public SpaeterEinkaufen___SpaeterEinkaufen_processChainProcessingAction_Action() {
		super("SpaeterEinkaufen___SpaeterEinkaufen_processChainProcessingAction_Action"); 
	}
