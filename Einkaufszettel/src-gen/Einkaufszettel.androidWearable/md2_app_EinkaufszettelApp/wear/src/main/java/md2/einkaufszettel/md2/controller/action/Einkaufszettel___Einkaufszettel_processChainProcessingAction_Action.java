...
public class Einkaufszettel___Einkaufszettel_processChainProcessingAction_Action extends AbstractMd2Action {

    public Einkaufszettel___Einkaufszettel_processChainProcessingAction_Action() {
		super("Einkaufszettel___Einkaufszettel_processChainProcessingAction_Action"); 
	}
