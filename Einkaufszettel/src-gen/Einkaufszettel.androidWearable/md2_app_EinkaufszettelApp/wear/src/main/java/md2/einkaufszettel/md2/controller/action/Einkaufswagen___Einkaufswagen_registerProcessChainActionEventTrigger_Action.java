...
public class Einkaufswagen___Einkaufswagen_registerProcessChainActionEventTrigger_Action extends AbstractMd2Action {

    public Einkaufswagen___Einkaufswagen_registerProcessChainActionEventTrigger_Action() {
		super("Einkaufswagen___Einkaufswagen_registerProcessChainActionEventTrigger_Action"); 
	}
