...
public class SpaeterEinkaufen___SpaeterEinkaufen_startupAction_Action extends AbstractMd2Action {

    public SpaeterEinkaufen___SpaeterEinkaufen_startupAction_Action() {
		super("SpaeterEinkaufen___SpaeterEinkaufen_startupAction_Action"); 
	}
    ...
    public void execute() {
		...
		try {
			var1 = new Md2CallTask(new SpaeterEinkaufen___SpaeterEinkaufen_registerProcessChainActionEventTrigger_Action());
			var1.execute();
		...
		try {
			var2 = new Md2CallTask(new SpaeterEinkaufen___processChainSetProcessChainFirstProcessChainAction_Action());
			var2.execute();
		}catch (Md2WidgetNotCreatedException e){
		...
		try {
			var3 = new Md2CallTask(new SpaeterEinkaufen_SpaeterEinkaufen_init_Action());
			var3.execute();
		}catch (Md2WidgetNotCreatedException e){
