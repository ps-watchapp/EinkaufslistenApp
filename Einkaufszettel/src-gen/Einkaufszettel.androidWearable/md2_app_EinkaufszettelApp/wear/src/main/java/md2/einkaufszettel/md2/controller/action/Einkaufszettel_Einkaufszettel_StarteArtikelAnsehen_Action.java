...
public class Einkaufszettel_Einkaufszettel_StarteArtikelAnsehen_Action extends AbstractMd2Action {

    public Einkaufszettel_Einkaufszettel_StarteArtikelAnsehen_Action() {
		super("Einkaufszettel_Einkaufszettel_StarteArtikelAnsehen_Action"); 
	}
    ...
    public void execute() {
		...
		try {
			var1 = new Md2CallTask(new Md2ContentProviderGetActiveAction("ArtikelAnsehenProvider","EinkaufszettelProvider"));
			var1.execute();
