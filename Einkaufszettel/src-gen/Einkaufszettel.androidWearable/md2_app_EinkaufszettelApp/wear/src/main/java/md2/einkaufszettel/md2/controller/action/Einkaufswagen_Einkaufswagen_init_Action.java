...
public class Einkaufswagen_Einkaufswagen_init_Action extends AbstractMd2Action {

    public Einkaufswagen_Einkaufswagen_init_Action() {
		super("Einkaufswagen_Einkaufswagen_init_Action"); 
	}
