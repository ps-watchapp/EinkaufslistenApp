...
public class ArtikelAnsehen_ArtikelAnsehen_close_Action extends AbstractMd2Action {

    public ArtikelAnsehen_ArtikelAnsehen_close_Action() {
		super("ArtikelAnsehen_ArtikelAnsehen_close_Action"); 
	}
    ...
    public void execute() {
		...
		try {
			var1 = new Md2CallTask(new Md2FireEventAction("CloseEvent"));
			var1.execute();
