...
public class Einkaufswagen___Einkaufswagen_startupAction_Action extends AbstractMd2Action {

    public Einkaufswagen___Einkaufswagen_startupAction_Action() {
		super("Einkaufswagen___Einkaufswagen_startupAction_Action"); 
	}
    ...
    public void execute() {
		...
		try {
			var1 = new Md2CallTask(new Einkaufswagen___Einkaufswagen_registerProcessChainActionEventTrigger_Action());
			var1.execute();
		...
		try {
			var2 = new Md2CallTask(new Einkaufswagen___processChainSetProcessChainFirstProcessChainAction_Action());
			var2.execute();
		}catch (Md2WidgetNotCreatedException e){
		...
		try {
			var3 = new Md2CallTask(new Einkaufswagen_Einkaufswagen_init_Action());
			var3.execute();
		}catch (Md2WidgetNotCreatedException e){
