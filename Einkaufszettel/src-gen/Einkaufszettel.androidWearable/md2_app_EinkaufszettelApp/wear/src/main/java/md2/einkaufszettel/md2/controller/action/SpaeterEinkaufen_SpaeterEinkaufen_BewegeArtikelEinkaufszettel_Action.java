...
public class SpaeterEinkaufen_SpaeterEinkaufen_BewegeArtikelEinkaufszettel_Action extends AbstractMd2Action {

    public SpaeterEinkaufen_SpaeterEinkaufen_BewegeArtikelEinkaufszettel_Action() {
		super("SpaeterEinkaufen_SpaeterEinkaufen_BewegeArtikelEinkaufszettel_Action"); 
	}
    ...
    public void execute() {
		...
		try {
			var1 = new Md2CallTask(new Md2ContentProviderGetActiveAction("ArtikelBewegenProvider","SpaeterEinkaufenProvider"));
			var1.execute();
		...
		try {
			var3 = new Md2CallTask(new Md2ContentProviderRemoveActiveAction("SpaeterEinkaufenProvider"));
			var3.execute();
		}catch (Md2WidgetNotCreatedException e){
