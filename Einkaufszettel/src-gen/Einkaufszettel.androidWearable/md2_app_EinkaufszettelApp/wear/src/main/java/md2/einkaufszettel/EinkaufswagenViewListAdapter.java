...
import md2.einkaufszettel.md2.controller.action.Einkaufswagen_Einkaufswagen_StarteArtikelAnsehen_Action;
import md2.einkaufszettel.md2.controller.action.Einkaufswagen_Einkaufswagen_BewegeArtikelEinkaufszettel_Action;
import md2.einkaufszettel.md2.controller.action.Einkaufswagen_Einkaufswagen_BewegeArtikelSpaeterEinkaufen_Action;

public class EinkaufswagenViewListAdapter extends RecyclerView.Adapter{
	...
	public EinkaufswagenViewListAdapter(){
		content = Md2ContentProviderRegistry.getInstance().getContentMultiProvider("EinkaufswagenProvider");
		swipeHandler = new Md2ButtonOnSwipeHandler();
		clickHandler = new Md2OnClickHandler();
		Md2Action ca = new Einkaufswagen_Einkaufswagen_StarteArtikelAnsehen_Action();
		clickHandler.registerAction(ca);
		Md2Action lsa = new Einkaufswagen_Einkaufswagen_BewegeArtikelEinkaufszettel_Action();
		swipeHandler.getLeftSwipeHandler().registerAction(lsa);
		Md2Action rsa = new Einkaufswagen_Einkaufswagen_BewegeArtikelSpaeterEinkaufen_Action();
	...
	public void onBindViewHolder(RecyclerView.ViewHolder vh, int i){
		...
		//Listener hinzufügen
		Md2UpdateListIndexAction indexAction = new Md2UpdateListIndexAction("EinkaufswagenView", i, content);
