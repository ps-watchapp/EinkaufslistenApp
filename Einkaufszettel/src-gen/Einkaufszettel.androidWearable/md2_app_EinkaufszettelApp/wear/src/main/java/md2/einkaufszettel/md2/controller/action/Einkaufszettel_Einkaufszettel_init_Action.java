...
public class Einkaufszettel_Einkaufszettel_init_Action extends AbstractMd2Action {

    public Einkaufszettel_Einkaufszettel_init_Action() {
		super("Einkaufszettel_Einkaufszettel_init_Action"); 
	}
