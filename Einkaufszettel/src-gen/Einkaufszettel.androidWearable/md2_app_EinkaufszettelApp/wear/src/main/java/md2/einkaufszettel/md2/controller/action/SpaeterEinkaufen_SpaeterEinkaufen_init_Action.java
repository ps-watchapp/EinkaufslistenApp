...
public class SpaeterEinkaufen_SpaeterEinkaufen_init_Action extends AbstractMd2Action {

    public SpaeterEinkaufen_SpaeterEinkaufen_init_Action() {
		super("SpaeterEinkaufen_SpaeterEinkaufen_init_Action"); 
	}
