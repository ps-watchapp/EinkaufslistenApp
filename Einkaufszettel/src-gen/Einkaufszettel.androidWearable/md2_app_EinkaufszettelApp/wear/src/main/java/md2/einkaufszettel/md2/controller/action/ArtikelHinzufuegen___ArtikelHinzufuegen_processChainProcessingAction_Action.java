...
public class ArtikelHinzufuegen___ArtikelHinzufuegen_processChainProcessingAction_Action extends AbstractMd2Action {

    public ArtikelHinzufuegen___ArtikelHinzufuegen_processChainProcessingAction_Action() {
		super("ArtikelHinzufuegen___ArtikelHinzufuegen_processChainProcessingAction_Action"); 
	}
