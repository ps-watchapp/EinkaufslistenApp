...
public class Einkaufszettel_Einkaufszettel_StarteArtikelHinzufuegen_Action extends AbstractMd2Action {

    public Einkaufszettel_Einkaufszettel_StarteArtikelHinzufuegen_Action() {
		super("Einkaufszettel_Einkaufszettel_StarteArtikelHinzufuegen_Action"); 
	}
    ...
    public void execute() {
		...
		try {
			var1 = new Md2CallTask(new Md2FireEventAction("StarteArtikelHinzufuegen"));
			var1.execute();
