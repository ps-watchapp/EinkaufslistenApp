...
public class Einkaufszettel_Einkaufszettel_BewegeArtikelEinkaufswagen_Action extends AbstractMd2Action {

    public Einkaufszettel_Einkaufszettel_BewegeArtikelEinkaufswagen_Action() {
		super("Einkaufszettel_Einkaufszettel_BewegeArtikelEinkaufswagen_Action"); 
	}
    ...
    public void execute() {
		...
		try {
			var2 = new Md2AttributeSetTask("ArtikelBewegenProvider", "status", new Md2Integer(1));
			var2.execute();
		}catch (Md2WidgetNotCreatedException e){
		...
		try {
			var4 = new Md2CallTask(new Md2ContentProviderAddAction("EinkaufswagenProvider","ArtikelBewegenProvider"));
			var4.execute();
		}catch (Md2WidgetNotCreatedException e){
