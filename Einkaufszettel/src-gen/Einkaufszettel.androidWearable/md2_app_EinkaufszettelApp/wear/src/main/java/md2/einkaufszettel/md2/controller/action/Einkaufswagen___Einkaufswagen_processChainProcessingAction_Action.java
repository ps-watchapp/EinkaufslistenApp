...
public class Einkaufswagen___Einkaufswagen_processChainProcessingAction_Action extends AbstractMd2Action {

    public Einkaufswagen___Einkaufswagen_processChainProcessingAction_Action() {
		super("Einkaufswagen___Einkaufswagen_processChainProcessingAction_Action"); 
	}
