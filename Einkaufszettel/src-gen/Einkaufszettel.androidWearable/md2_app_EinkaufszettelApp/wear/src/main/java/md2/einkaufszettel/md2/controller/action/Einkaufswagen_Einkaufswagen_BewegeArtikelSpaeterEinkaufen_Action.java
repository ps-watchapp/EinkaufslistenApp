...
public class Einkaufswagen_Einkaufswagen_BewegeArtikelSpaeterEinkaufen_Action extends AbstractMd2Action {

    public Einkaufswagen_Einkaufswagen_BewegeArtikelSpaeterEinkaufen_Action() {
		super("Einkaufswagen_Einkaufswagen_BewegeArtikelSpaeterEinkaufen_Action"); 
	}
