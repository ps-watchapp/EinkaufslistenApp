...
public class ArtikelHinzufuegen___ArtikelHinzufuegen_startupAction_Action extends AbstractMd2Action {

    public ArtikelHinzufuegen___ArtikelHinzufuegen_startupAction_Action() {
		super("ArtikelHinzufuegen___ArtikelHinzufuegen_startupAction_Action"); 
	}
    ...
    public void execute() {
		...
		try {
			var1 = new Md2CallTask(new ArtikelHinzufuegen___ArtikelHinzufuegen_registerProcessChainActionEventTrigger_Action());
			var1.execute();
		...
		try {
			var2 = new Md2CallTask(new ArtikelHinzufuegen___processChainSetProcessChainFirstProcessChainAction_Action());
			var2.execute();
		}catch (Md2WidgetNotCreatedException e){
		...
		try {
			var3 = new Md2CallTask(new ArtikelHinzufuegen_ArtikelHinzufuegen_init_Action());
			var3.execute();
		}catch (Md2WidgetNotCreatedException e){
