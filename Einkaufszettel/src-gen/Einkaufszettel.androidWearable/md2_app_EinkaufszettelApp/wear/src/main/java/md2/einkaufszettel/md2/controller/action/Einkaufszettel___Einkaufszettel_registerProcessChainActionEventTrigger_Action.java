...
public class Einkaufszettel___Einkaufszettel_registerProcessChainActionEventTrigger_Action extends AbstractMd2Action {

    public Einkaufszettel___Einkaufszettel_registerProcessChainActionEventTrigger_Action() {
		super("Einkaufszettel___Einkaufszettel_registerProcessChainActionEventTrigger_Action"); 
	}
