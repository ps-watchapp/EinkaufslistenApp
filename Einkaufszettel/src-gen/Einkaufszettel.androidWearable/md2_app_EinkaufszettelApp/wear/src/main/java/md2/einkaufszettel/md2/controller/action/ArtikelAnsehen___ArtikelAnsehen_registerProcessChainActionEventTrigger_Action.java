...
public class ArtikelAnsehen___ArtikelAnsehen_registerProcessChainActionEventTrigger_Action extends AbstractMd2Action {

    public ArtikelAnsehen___ArtikelAnsehen_registerProcessChainActionEventTrigger_Action() {
		super("ArtikelAnsehen___ArtikelAnsehen_registerProcessChainActionEventTrigger_Action"); 
	}
