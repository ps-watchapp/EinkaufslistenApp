...
public class SpaeterEinkaufenViewActivity extends WearableActivity implements WearableActionDrawer.OnMenuItemClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_spaetereinkaufenview);

        clickHandler = new Md2OnClickHandler();


	     		drawerLayout = (WearableDrawerLayout) findViewById(R.id.drawer_layout_SpaeterEinkaufenView);
	        	drawerLayout.setDrawerStateCallback(new WearableDrawerLayout.DrawerStateCallback() {
	            	...
	            	public void onDrawerClosed(View view) {
	                	if(adapter.close()){
	                		SpaeterEinkaufenViewActivity.this.finish();
	                	}
	            	}
	            	@Override
        ...
        navigationDrawer = (WearableNavigationDrawer) findViewById(R.id.navigation_drawer_SpaeterEinkaufenView);
		...
		WearableRecyclerView wrv = (WearableRecyclerView) findViewById(R.id.wearable_recycler_view_SpaeterEinkaufenView);
							    	SpaeterEinkaufenViewListAdapter listAdapter = new SpaeterEinkaufenViewListAdapter();
