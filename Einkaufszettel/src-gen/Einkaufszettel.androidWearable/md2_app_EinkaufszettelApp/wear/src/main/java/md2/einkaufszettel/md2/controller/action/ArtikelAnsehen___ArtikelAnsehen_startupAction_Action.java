...
public class ArtikelAnsehen___ArtikelAnsehen_startupAction_Action extends AbstractMd2Action {

    public ArtikelAnsehen___ArtikelAnsehen_startupAction_Action() {
		super("ArtikelAnsehen___ArtikelAnsehen_startupAction_Action"); 
	}
    ...
    public void execute() {
		...
		try {
			var1 = new Md2CallTask(new ArtikelAnsehen___ArtikelAnsehen_registerProcessChainActionEventTrigger_Action());
			var1.execute();
		...
		try {
			var2 = new Md2CallTask(new ArtikelAnsehen___processChainSetProcessChainFirstProcessChainAction_Action());
			var2.execute();
		}catch (Md2WidgetNotCreatedException e){
		...
		try {
			var3 = new Md2CallTask(new ArtikelAnsehen_ArtikelAnsehen_init_Action());
			var3.execute();
		}catch (Md2WidgetNotCreatedException e){
