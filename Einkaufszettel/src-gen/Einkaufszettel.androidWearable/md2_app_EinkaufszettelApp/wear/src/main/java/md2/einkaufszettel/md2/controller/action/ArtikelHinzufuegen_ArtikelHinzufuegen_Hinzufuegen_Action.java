...
public class ArtikelHinzufuegen_ArtikelHinzufuegen_Hinzufuegen_Action extends AbstractMd2Action {

    public ArtikelHinzufuegen_ArtikelHinzufuegen_Hinzufuegen_Action() {
		super("ArtikelHinzufuegen_ArtikelHinzufuegen_Hinzufuegen_Action"); 
	}
    ...
    public void execute() {
		...
		try {
			var1 = new Md2AttributeSetTask("ArtikelHinzufuegenProvider", "status", new Md2Integer(0));
			var1.execute();
		...
		try {
			var2 = new Md2CallTask(new Md2ContentProviderAddAction("EinkaufszettelProvider","ArtikelHinzufuegenProvider"));
			var2.execute();
		}catch (Md2WidgetNotCreatedException e){
		...
		try {
			var3 = new Md2CallTask(new Md2FireEventAction("CloseEvent"));
			var3.execute();
		}catch (Md2WidgetNotCreatedException e){
