...
public class ArtikelAnsehenViewActivity extends WearableActivity implements WearableActionDrawer.OnMenuItemClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_artikelansehenview);

        clickHandler = new Md2OnClickHandler();

        Md2Label artikelAnsehenView_BezeichnungLabel = (Md2Label) findViewById(R.id.ArtikelAnsehenView_BezeichnungLabel);
        artikelAnsehenView_BezeichnungLabel.setWidgetId(R.id.ArtikelAnsehenView_BezeichnungLabel);
        Md2WidgetRegistry.getInstance().addWidget(artikelAnsehenView_BezeichnungLabel);
        Md2Label artikelAnsehenView_AnzahlLabel = (Md2Label) findViewById(R.id.ArtikelAnsehenView_AnzahlLabel);
        artikelAnsehenView_AnzahlLabel.setWidgetId(R.id.ArtikelAnsehenView_AnzahlLabel);
        Md2WidgetRegistry.getInstance().addWidget(artikelAnsehenView_AnzahlLabel);

	     		drawerLayout = (WearableDrawerLayout) findViewById(R.id.drawer_layout_ArtikelAnsehenView);
	        	drawerLayout.setDrawerStateCallback(new WearableDrawerLayout.DrawerStateCallback() {
	            	...
	            	public void onDrawerClosed(View view) {
	                	if(adapter.close()){
	                		ArtikelAnsehenViewActivity.this.finish();
	                	}
	            	}
	            	@Override
        ...
        navigationDrawer = (WearableNavigationDrawer) findViewById(R.id.navigation_drawer_ArtikelAnsehenView);
    ...
    protected void onStart(){
        ...
        Md2Label artikelAnsehenView_BezeichnungLabel = (Md2Label) findViewById(R.id.ArtikelAnsehenView_BezeichnungLabel);
        Md2WidgetRegistry.getInstance().loadWidget(artikelAnsehenView_BezeichnungLabel);
        Md2Label artikelAnsehenView_AnzahlLabel = (Md2Label) findViewById(R.id.ArtikelAnsehenView_AnzahlLabel);
        Md2WidgetRegistry.getInstance().loadWidget(artikelAnsehenView_AnzahlLabel);
