...
public class Einkaufswagen_Einkaufswagen_StarteArtikelAnsehen_Action extends AbstractMd2Action {

    public Einkaufswagen_Einkaufswagen_StarteArtikelAnsehen_Action() {
		super("Einkaufswagen_Einkaufswagen_StarteArtikelAnsehen_Action"); 
	}
    ...
    public void execute() {
		...
		try {
			var1 = new Md2CallTask(new Md2ContentProviderGetActiveAction("ArtikelAnsehenProvider","EinkaufswagenProvider"));
			var1.execute();
