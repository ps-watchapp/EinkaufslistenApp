...
public class ArtikelHinzufuegen_ArtikelHinzufuegen_init_Action extends AbstractMd2Action {

    public ArtikelHinzufuegen_ArtikelHinzufuegen_init_Action() {
		super("ArtikelHinzufuegen_ArtikelHinzufuegen_init_Action"); 
	}
    ...
    public void execute() {
		...
		try {
			var1 = new Md2MapTask("ArtikelHinzufuegenProvider", R.id.ArtikelHinzufuegenView_Input_BezeichnungTextfeld, "bezeichnung");
			var1.execute();
		...
		try {
			var2 = new Md2MapTask("ArtikelHinzufuegenProvider", R.id.ArtikelHinzufuegenView_Input_AnzahlIntegerfeld, "anzahl");
			var2.execute();
		}catch (Md2WidgetNotCreatedException e){
			Md2TaskQueue.getInstance().addPendingTask(var2);
		}
		Md2BindTask var3 = null;
		try {
			var3 = new Md2BindTask(new ArtikelHinzufuegen_ArtikelHinzufuegen_Hinzufuegen_Action(), R.id.ArtikelHinzufuegenView_Buttons_HinzufuegenButton, Md2WidgetEventType.ON_CLICK
			);
			var3.execute();
		}catch (Md2WidgetNotCreatedException e){
