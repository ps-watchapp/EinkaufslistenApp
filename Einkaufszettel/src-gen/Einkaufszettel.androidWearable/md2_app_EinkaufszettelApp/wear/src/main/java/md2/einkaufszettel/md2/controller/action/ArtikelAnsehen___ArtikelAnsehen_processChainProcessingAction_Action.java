...
public class ArtikelAnsehen___ArtikelAnsehen_processChainProcessingAction_Action extends AbstractMd2Action {

    public ArtikelAnsehen___ArtikelAnsehen_processChainProcessingAction_Action() {
		super("ArtikelAnsehen___ArtikelAnsehen_processChainProcessingAction_Action"); 
	}
