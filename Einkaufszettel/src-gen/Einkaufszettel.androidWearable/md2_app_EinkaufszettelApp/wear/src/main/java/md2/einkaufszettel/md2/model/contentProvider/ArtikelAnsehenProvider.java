...
import de.uni_muenster.wi.md2library.controller.eventhandler.implementation.Md2OnAttributeChangedHandler;
			...
			public class ArtikelAnsehenProvider    extends AbstractMd2ContentProvider {
			
			    			
			    public ArtikelAnsehenProvider(String key, Md2Entity content, Md2DataStore md2DataStore) {
