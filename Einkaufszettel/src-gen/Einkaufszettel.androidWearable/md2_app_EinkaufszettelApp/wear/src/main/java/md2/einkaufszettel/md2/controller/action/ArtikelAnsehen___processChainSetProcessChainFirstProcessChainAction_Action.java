...
public class ArtikelAnsehen___processChainSetProcessChainFirstProcessChainAction_Action extends AbstractMd2Action {

    public ArtikelAnsehen___processChainSetProcessChainFirstProcessChainAction_Action() {
		super("ArtikelAnsehen___processChainSetProcessChainFirstProcessChainAction_Action"); 
	}
    ...
    public void execute() {
		...
		try {
			var2 = new Md2CallTask(new ArtikelAnsehen___ArtikelAnsehen_processChainExecuteStepAction_Action());
			var2.execute();
		}catch (Md2WidgetNotCreatedException e){
